...
''''Defining Alarm with imprting Beep Sound Using Winsound Module'''
def alarm():
        ...
        if main_time2 == 'PM':                                  #Giving condition for alarm 
...
'''Defining stopwatch counter Functions'''       
...
def timer_counter(label):
        def count():
                ...
                if timer_running:
                        ...
                        label.after(1000, count)
        count()
def timer(work):#Defining  Timer functions with using global time running counter 
         if work == 'start':
                 ...
                 timer_running=False                                  #Giving Condition
...
time_label = Label(clock_tab, font = 'calibri 40 bold', foreground = 'cyan', background='black')#Fonts and Background Color and Foregground color 
time_label.pack(anchor='center')
date_label = Label(clock_tab, font = 'calibri 40 bold', foreground = 'cyan', background='black')
...
clock()
window.mainloop()  #Command to Run The Program
